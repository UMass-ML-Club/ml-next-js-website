...
const Header = () => {
  ...
  return (
    <header
      className={`top-0 z-40 mx-auto w-full flex-none bg-umass-red transition-all duration-100 ease-in md:backdrop-blur-sm ${
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-3 py-3 md:flex md:justify-between md:px-4 md:py-3.5">
        ...
        <nav
          ...
          } w-auto overflow-y-auto text-gray-200 dark:text-slate-200 md:mx-5 md:flex md:h-auto md:items-center md:overflow-visible`}
